      ...
      {active && (
        <div
          ...
          style={{
            ...
            background:
              "conic-gradient(from 0deg, #F5C95B, #E8B53A, #F8D980, #F5C95B)",
            animation:
      ...
      <div className='max-w-3xl mx-auto px-6 pt-12 pb-20'>
        <div className='text-center mb-8'>
          ...
          <p className='mt-4 text-[15px] text-ink-500 max-w-lg mx-auto leading-relaxed'>
            Speak in English — get a live transcript, then translate it into
            Nuer or Dinka.
          </p>
        </div>
            ...
            <div className='flex justify-center my-5'>
              ...
              >
                {isTranslating ? (
                  ...
                  <>
                    <Sparkle /> Translate to {getLangName(lang)}
                  </>
                )}
              </button>
            </div>
        ...
        <p className='mt-5 text-center text-xs text-ink-400'>
          Voice input requires microphone access and a Chromium-based or Safari
          browser.
        </p>
      </div>
    </div>
